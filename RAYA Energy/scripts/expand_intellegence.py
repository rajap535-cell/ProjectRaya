...
# Paths
ENHANCED_DATA_PATH = os.path.join("RAYA Energy", "data", "state_energy_enhanced.csv")
INDICES_DATA_PATH = os.path.join("RAYA Energy", "data", "state_energy_indices.csv")
OUTPUT_PATH = os.path.join("RAYA Energy", "data", "state_energy_intelligence.csv")
